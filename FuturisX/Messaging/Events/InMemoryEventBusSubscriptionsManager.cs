...
{
    public partial class InMemoryEventBusSubscriptionsManager : IEventBusSubscriptionsManager, ISingletonDependency
    {
        ...
        private void DoAddSubscription(Type handlerType, string eventName, bool isDynamic)
        {
            ...
            if (_handlers[eventName].Any(s => s.HandlerType == handlerType))
            {
                throw new ArgumentException(
                    $"Handler Type {handlerType.Name} already registerd for '{eventName}'", nameof(handlerType));
            }
