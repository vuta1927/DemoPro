namespace FuturisX.AspNetCore.Mvc.Models
{
    public abstract class AjaxResponseBase
    {
        ...
        /// <summary>
        /// A special signature for AJAX responses. It's used in the client to detect if this is a response wrapped by APP.
        /// </summary>
        public bool __app { get; } = true;
    }
}