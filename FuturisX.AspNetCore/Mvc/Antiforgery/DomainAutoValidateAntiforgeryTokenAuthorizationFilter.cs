...
{
    public class DomainAutoValidateAntiforgeryTokenAuthorizationFilter : AutoValidateAntiforgeryTokenAuthorizationFilter, ITransientDependency
    {
        private readonly AntiforgeryOptions _options;

        public DomainAutoValidateAntiforgeryTokenAuthorizationFilter(
